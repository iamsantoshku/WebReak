...
//                                 <div className='bg-slate-200 h-72 p-4 min-w-[200px] md:min-w-[145px] flex justify-center items-center'>
//                                     <img src={product.productImage[0]} className='object-cover h-full w-full hover:scale-110 transition-all' alt={product?.productName} />
//                                 </div>
//                             </Link>
...
//                                 </button>
//                                 <button onClick={(e) => handleAddToCart(e, product._id)} className='bg-white p-1 rounded-full shadow-md'>
...
//                                     {/* <button className='text-sm bg-green-600 hover:bg-red-700 text-white px-3 py-0.5 rounded-full' onClick={(e) => handleAddToWishlist(e, product?._id)}>Add to WishList</button> */}
//                                 </div>
//                             </div>
//                         </div>
//                     ))
