...
//                 ) : (
//                     data.map((product, index) => (
//                         <Link key={index} to={`/product/${product?.productName}`} className='w-full min-w-[280px] md:min-w-[300px] max-w-[280px] md:max-w-[300px] bg-white rounded-sm shadow' onClick={scrollTop}>
//                             <div className='bg-slate-200 h-48 p-4 min-w-[280px] md:min-w-[145px] flex justify-center items-center'>
//                                 <img src={product?.productImage[0]} className='object-scale-down h-full hover:scale-110 transition-all mix-blend-multiply' alt={product?.productName} />
//                             </div>
//                             <div className='p-4 grid gap-3'>
